...
def main():
    ...
    for part_id in part_dict:
        ...
        print(
            f'part {part_id} has {part.number_of_nodes()} nodes and {part.number_of_edges()} edges. {num_inner_nodes} nodes and {num_inner_edges} edges are inside the partition'
        )
    ...
    print(
        f'there are {g.number_of_edges()} edges in the graph and {g.number_of_edges() - tot_num_inner_edges} edge cuts for {len(part_dict)} partitions.'
    )
